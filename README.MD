# SmtpRouter.Windows Components - v1.0.0.2
...
A Routing Rule is a class that derives from the `RoutingRule` base class. Therefore, the system cannot now what kinds of routing rules to expect. 
